...
export default function AdminMapView({ onBack }: AdminMapViewProps) {
    ...
    const fetchChargingPointById = async (chargingPointId: number): Promise<ChargingPoint | null> => {
        try {
            const res = await axios.get(`http://localhost:8080/api/charging-points/${chargingPointId}`);
    ...
    const fetchMapTilerPOIs = async () => {
        ...
        try {
            ...
            const mockPOI = [
                ...
                { id: "poi-4", name: "Ký túc xá khu B - ĐHQG TP.HCM", address: "Đường Hàn Thuyên, Dĩ An, Bình Dương", longitude: 106.8004, latitude: 10.8757 },

                { id: "poi-5", name: "Đại học FPT TP.HCM", address: "Lô E2a-7, Đường D1, Khu Công nghệ cao, Quận 9, TP.HCM", longitude: 106.8099, latitude: 10.8413 },

                { id: "poi-6", name: "Nhà văn hóa sinh viên ĐHQG TP.HCM", address: "Đường Hàn Thuyên, Dĩ An, Bình Dương", longitude: 106.8020, latitude: 10.8730 },

                { id: "poi-7", name: "Vinhomes Grand Park", address: "Nguyễn Xiển, Quận 9, TP.HCM", longitude: 106.8626, latitude: 10.8450 }
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                                            ...
                                            <Dialog open={isAddChargingPointDialogOpen} onOpenChange={setIsAddChargingPointDialogOpen}>
                                                <DialogTrigger asChild>
                                                    ...
                                                    >
                                                        <Plus className="w-4 h-4" />
                                                        <span>{language === 'vi' ? 'Thêm trụ sạc' : 'Add Charging Point'}</span>
                                                    </Button>
                                                </DialogTrigger>
                                                <DialogContent className="max-w-md bg-card/95 backdrop-blur-xl border-border/50">
                                                    <DialogHeader>
                                                        <DialogTitle className="text-foreground">
                                                            {language === 'vi' ? 'Thêm trụ sạc mới' : 'Add New Charging Point'}
                                                        </DialogTitle>
                                                    ...
                                                    <div className="flex justify-end space-x-2 pt-4 border-t border-border/30">
                                                        ...
                                                        >
                                                            {loading ? t('loading') : (language === 'vi' ? 'Thêm trụ sạc' : 'Add Point')}
                                                        </Button>
                                                    </div>
                                                </DialogContent>
                                            </Dialog>
